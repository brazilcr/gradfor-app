package io.github.gradfor.config;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .csrf().disable(); // Opcional: desabilita CSRF para permitir requisições sem proteção
...
//            requests.requestMatchers("/api/**","/api/cursos","/api/cursos/**", "/favicon.ico").permitAll();
//            //requests.requestMatchers("/xxxxx").hasAuthority("teste");
